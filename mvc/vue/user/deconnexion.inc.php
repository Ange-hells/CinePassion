...
if(!isset($_SESSION['Utilisateur'])) {
	...
	?>
	<ul>
		<li>La durée de votre connexion a été de 3 secondes.</li>
		<li>Vous pouvez vous reconnecter à tout moment à partir du formulaire d'authentification.</li>
		<li>Merci de votre visite Armelle Couvert et à bientôt.</li>
	</ul>
<?php 
}else {
	?>
