		...
		<table id="tab">	  
            ...
            <tbody>
                <tr>
                    ...
                    ?>
                <tr class="ligne">
                    <td class="titre"><?php echo"<a href='./index.php?module=film&page=fiche&section=".$unFilm->numFilm."'"?><abbr title='film realisé par <?php echo $unFilm->prenomReal . " " . $unFilm->nomReal; ?>'><?php echo $unFilm->titreFilm; ?></abbr></a></td>
	...
	<span class='contentInfos'>
		<div class='navigation'>
			<div id="boutons"> 
    			...
    			<?php echo $nav->getNumeros($nbAffiches); ?>
    		</div>
    	</div>
